...
ListFactory::ListFactory(SDL_Renderer*const renderer, const Point<int>& position) : ComponentFactory{ renderer, position }, glyphAtlas{ nullptr }, hasSetGlyphAtlas{ false },
  fontName{ 0u }, hasSetFontName{ false }, fontSize{ 0u }, hasSetFontSize{ false }, keyMargin{ 1, 1 }, keyPaddings{ Size{ 1, 1 } },
  keyPaint{ Size{ 1, 1 }, Color{ 0u, 0u, 0u, static_cast<unsigned int>(MAX_COLOR.a) } }, textPairs{ Pair{ string{ " " }, string{ " " } } },
