...
ViewGroup ViewifyViewGroupFactory::make(SDL_Renderer*const renderer, const Size<int>& size) {
  return ViewGroup{ renderer, Point{ 0, 0 }, [this, size](ViewGroup&, SDL_Renderer*const renderer) {
    return vector<View*>{
      new Page<Path>{ renderer, Point{ 0, 0 }, Path::MAIN, &currentPath, [this, size](ViewGroup& self, SDL_Renderer*const renderer) {
        return vector<View*>{
          ...
          Score::Builder{ renderer, headFont, Point{ 76, 160 }, Color{ 0u, 0u, 0u, 255u }, 4u, []() {} }.setCanIncrement(&canIncrementScore0).setCanReset(&canResetScore0).build(),
          Score::Builder{ renderer, bodyFont, Point{ 192, 168 }, Color{ 0u, 0u, 0u, 255u }, 4u, []() {} }.setCanIncrement(&canIncrementScore0).setCanReset(&canResetScore0).build(),
          Score::Builder{ renderer, bodyFont, Point{ 272, 168 }, Color{ 0u, 0u, 0u, 255u }, 4u, []() {} }.setCanIncrement(&canIncrementScore0).setCanReset(&canResetScore0).build(),
          Score::Builder{ renderer, bodyFont, Point{ 352, 168 }, Color{ 128u, 128u, 128u, 255u }, 4u, []() {} }.setCanIncrement(&canIncrementScore0).setCanReset(&canResetScore0).build(),
          Score::Builder{ renderer, bodyFont, Point{ 432, 168 }, Color{ 128u, 128u, 128u, 255u }, 8u, []() {} }.setCanIncrement(&canIncrementScore0).setCanReset(&canResetScore0).build(),
          Score::Builder{ renderer, bodyFont, Point{ 512, 168 }, Color{ 128u, 128u, 128u, 255u }, 8u, []() {
            cout << "You win!\n";
          } }.setCanIncrement(&canIncrementScore0).setCanReset(&canResetScore0).build(),
          Score::Builder{ renderer, bodyFont, Point{ 592, 168 }, Color{ 128u, 128u, 128u, 255u }, 8u, []() {
            cout << "You win!\n";
          } }.setCanIncrement(&canIncrementScore0).setCanReset(&canResetScore0).build(),
          Score::Builder{ renderer, bodyFont, Point{ 672, 168 }, Color{ 128u, 128u, 128u, 128u }, 8u, []() {
            cout << "You win!\n";
          ...
          new ViewGroup{ renderer, Point{ 16, 760 }, [this](ViewGroup&, SDL_Renderer*const renderer) {
            return vector<View*>{
          ...
          new ViewGroup{ renderer, Point{ 240, 760 }, [](ViewGroup&, SDL_Renderer*const renderer) {
            return vector<View*>{
          ...
          Button::Builder{ renderer, Point{ (size.w - navButtonSize.w) >> 1u, size.h - navButtonSize.h - 16 }, Paint{ navButtonSize, Color{ 192u, 192u, 255u, 255u } } }
            .setA(255u)
            .setADuration(1u)
            .setLightnessDuration(128u)
            .setOnMouseMove([this]() {
            ...
            .setOnMouseOver([]() {})
            .build(),
          Text::Builder{ renderer, bodyFont, Point{ size.w >> 1u, size.h - navButtonSize.h - 2 }, "Next page", Color{ 0u, 0u, 0u, 255u }, Align::CENTER }.setDuration(1u).build(),
          new Modal{
            renderer, size, Point{ (size.w - modalSize1.w) >> 1u, (size.h - modalSize1.h) >> 1u }, Paint{ modalSize1, Color{ 255u, 255u, 255u, 255u } }, &isModal1Showing, 128u,
            [this, &self](ViewGroup&, SDL_Renderer*const renderer) {
              return vector<View*>{
          ...
          new Modal{
            renderer, size, Point{ (size.w - modalSize2.w) >> 1u, (size.h - modalSize2.h) >> 1u }, Paint{ modalSize2, Color{ 255u, 255u, 255u, 255u } }, &isModal2Showing, 128u,
            [this, &self](ViewGroup&, SDL_Renderer*const renderer) {
              return vector<View*>{
          ...
          new Modal{
            renderer, size, Point{ (size.w - modalSize2.w) >> 1u, (size.h - modalSize2.h) >> 1u }, Paint{ modalSize2, Color{ 255u, 0u, 0u, 255u } }, &isModal3Showing, 128u,
            [this, &self](ViewGroup&, SDL_Renderer*const renderer) {
              return vector<View*>{
          ...
          new Modal{
            renderer, size, Point{ (size.w - modalSize2.w) >> 1u, (size.h - modalSize2.h) >> 1u }, Paint{ modalSize2, Color{ 255u, 0u, 0u, 255u } }, &isModal4Showing, 128u,
            [this, &self](ViewGroup&, SDL_Renderer*const renderer) {
              return vector<View*>{
          ...
          new Modal{
            renderer, size, Point{ (size.w - modalSize2.w) >> 1u, (size.h - modalSize2.h) >> 1u }, Paint{ modalSize2, Color{ 255u, 0u, 0u, 255u } }, &isModal5Showing, 256u,
            [this, &self](ViewGroup&, SDL_Renderer*const renderer) {
              return vector<View*>{
          ...
          new Modal{
            renderer, size, Point{ (size.w - modalSize2.w) >> 1u, (size.h - modalSize2.h) >> 1u }, Paint{ modalSize2, Color{ 255u, 0u, 0u, 255u } }, &isModal6Showing, 256u,
            [this, &self](ViewGroup&, SDL_Renderer*const renderer) {
              return vector<View*>{
                Button::Builder{ renderer, Point{ 140, 120 }, Paint{ Size{ 96, 48 }, Color{ 192u, 192u, 192u, 255u } } }
                  .setA(255u)
      ...
      new Page<Path>{ renderer, Point{ 0, 0 }, Path::EMPTY, &currentPath, [this, size](ViewGroup&, SDL_Renderer*const renderer) {
        return vector<View*>{
          Button::Builder{ renderer, Point{ (size.w - navButtonSize.w) >> 1u, size.h - navButtonSize.h - 16 }, Paint{ navButtonSize, Color{ 192u, 192u, 255u, 255u } } }
            .setA(255u)
            .setADuration(1u)
            ...
            .setOnMouseOver([]() {})
            .build(),
          Text::Builder{ renderer, bodyFont, Point{ size.w >> 1u, size.h - navButtonSize.h - 2 }, "Prev page", Color{ 0u, 0u, 0u, 255u }, Align::CENTER }.setDuration(1u).build(),
        };
      } }
    };
  } };
